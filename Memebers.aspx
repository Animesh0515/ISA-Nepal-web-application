        ...
        <div class="row">
            <div class="col-md-15" >
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <asp:TextBox CssClass="auto-style2" ID="txtcustomername" runat="server" placeholder="Search" Width="257px"></asp:TextBox>

                        &nbsp;&nbsp;&nbsp;&nbsp;

                        <asp:Button ID="btnAdd" class="btn btn-lg btn-block btn-danger" runat="server" Text="Search" Style="padding-left: 20px; text-align: center; font-size: 1.15rem; line-height: 1;"  Width="100px" />
